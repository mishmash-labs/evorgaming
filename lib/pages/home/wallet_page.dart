        ...
        builder: (context, state) {
          if (state is AccountLoaded) {
            return RefreshIndicator(
              onRefresh: () => accountCubit.refresh(
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: RaisedButton(
                                  onPressed: () async {
                                    var userID = Provider.of<UserData>(context,
                                            listen: false)
                                        .userNumID;
                                    ...
                                    if (await canLaunch(url)) {
                                      await launch(url).then((val) =>
                                          accountCubit.refresh(
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              "You can pull to refresh if your coins do not show up.",
                              style: TextStyle(
